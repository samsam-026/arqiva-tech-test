                    ...
                    <Row className="justify-content-end">
                      <Col lg={4} md={6}>
                        <Form.Group className="my-3">
                          <Form.Label>Search by</Form.Label><br/>
                          {ContributionSearchOptions.map((option, index) => <Form.Check
                            inline
                            key={index}
                            value={option}
                      ...
                      <Col lg={4} md={6}>
                        <Form.Group className="my-3">
                          ...
                          <Form.Control value={searchQuery} onChange={(e) => handleSearchQueryChange(e.target.value)}></Form.Control>
                        </Form.Group>
                      </Col>
                      <Col lg={4} md={6}>
